def generate_messages(variables):
  ...
  base_monetaria = next((item for item in variables if item["id"] == 15), None)
  base_monetaria_message = generate_base_monetaria_message(base_monetaria) if base_monetaria else None
  
  circulante_monetario = next((item for item in variables if item["id"] == 16), None)
  ...
  tasa_politica_monetaria_ea = next((item for item in variables if item["id"] == 34), None)
